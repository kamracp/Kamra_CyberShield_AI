...
import DeviceFingerprintDashboard from "./modules/device-fingerprint/pages/DeviceFingerprintDashboard";
    ...
    <BrowserRouter>
      <MainLayout>
        <Routes>
          ...
          <Route path="/aml" element={<AMLMonitor />} />
          <Route path="/compliance" element={<ComplianceMonitor />} />
          <Route path="/upi" element={<UPIDashboard />} />
          <Route path="/fraud-engine" element={<FraudDashboard />} />
          <Route path="/sim-swap" element={<SimSwapDashboard />} />
          <Route path="/velocity-risk" element={<VelocityRiskDashboard />} />
          <Route path="/geo-risk" element={<GeoRiskDashboard />} />
          <Route path="/impossible-travel" element={<ImpossibleTravelDashboard />} />
          <Route path="/deepfake" element={<DeepfakeDashboard />} />
          <Route path="/device-fingerprint" element={<DeviceFingerprintDashboard />} />
        </Routes>
      </MainLayout>
    </BrowserRouter>
  );
